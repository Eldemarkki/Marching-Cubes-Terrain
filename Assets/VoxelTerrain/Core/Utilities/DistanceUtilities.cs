...
namespace Eldemarkki.VoxelTerrain.Utilities
{
    ...
    {
        /// <summary>
        /// Calculates the difference between <paramref name="pointA"/> and <paramref name="pointB"/>, and returns true if any of the xyz components of the difference is greater than <paramref name="maximumAllowed"/>. If all of the xyz components of the difference are less than or equal to <paramref name="maximumAllowed"/> it returns false. The formal name of this distance calculation is Chebyshev distance. This compares if the Chebyshev distance is greater than <paramref name="maximumAllowed"/>
        /// </summary>
